...
<div class="container">
  ...
  <div class="category-filters" id="categoryFilters">
    ...
    <button onclick="filterCategory('none')">미학습 <span class="filter-count" id="countNone"></span></button>
    <button onclick="filterCategory('learned')">학습 완료 <span class="filter-count" id="countLearned"></span></button>
    <button onclick="filterCategory('confused')">헷갈리는 단어 <span class="filter-count" id="countConfused"></span></button>
...
function goPage(p) {
  const totalPages = Math.ceil(getDisplayWords().length / PAGE_SIZE);
...
function startTest(customWords) {
  ...
  var countVal = document.getElementById('testQuestionCount').value;
...
function selectChoice(idx) {
  ...
  if (isCorrect) {
    ...
    document.getElementById('testAnswerReveal').innerHTML = '<span class="feedback-wrong">오답!</span> <span style="color:#94a3b8;">정답: <strong style="color:#60a5fa;">' + word.word + '</strong> ' + word.meaning + '</span>';
  }
